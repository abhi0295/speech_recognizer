...
IFontDisp = Font
__all__ = [ 'IFontDisp', 'OLE_TRISTATE', 'OLE_YSIZE_PIXELS',
           'StdFont', 'IFont', 'OLE_COLOR', 'OLE_XPOS_PIXELS',
           'Picture', 'OLE_XSIZE_CONTAINER', 'IPictureDisp',
           'VgaColor', 'OLE_YSIZE_CONTAINER', 'OLE_HANDLE',
           'FONTNAME', 'LoadPictureConstants', 'FONTITALIC',
           'Checked', 'OLE_YPOS_HIMETRIC', 'Gray', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_CONTAINER', 'FONTSIZE', 'FONTUNDERSCORE',
           'StdPicture', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XPOS_CONTAINER', 'Unchecked', 'Color', 'IPicture',
           'FONTSTRIKETHROUGH', 'Default', 'Font', 'IFontEventsDisp',
           'OLE_OPTEXCLUSIVE', 'FONTBOLD', 'OLE_YPOS_PIXELS',
           'FontEvents', 'OLE_CANCELBOOL', 'Monochrome',
